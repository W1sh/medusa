...
@Component
public final class WishlistAddCommandService implements ApplicationCommandService {

    private static final String COMMAND_NAME = "wishlist-add";

    private final WishlistService wishlistService;
    private final CardService cardService;

    public WishlistAddCommandService(WishlistService wishlistService, CardService cardService) {
